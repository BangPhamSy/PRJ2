						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="#"> <span class="pull-right">(56)</span>NEM</a></li>
									<li><a href="#"> <span class="pull-right">(27)</span>Việt tiến</a></li>
									<li><a href="#"> <span class="pull-right">(32)</span>BKAV</a></li>
